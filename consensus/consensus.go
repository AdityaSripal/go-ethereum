...
type Engine interface {
	...
	// FinalizeAndAssemble runs any post-transaction state modifications (e.g.
	// block rewards or process withdrawals) and assembles the final block. The
	// block header and state database might be updated to reflect any consensus
	// rules that happen at finalization (e.g. block rewards).
