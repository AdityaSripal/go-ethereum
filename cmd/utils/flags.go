...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	flags.CheckExclusive(ctx, MainnetFlag, DeveloperFlag, SepoliaFlag, HoodiFlag, OverrideGenesisFlag, ChiadoFlag, GnosisChainFlag)
...
func MakeBeaconLightConfig(ctx *cli.Context) bparams.ClientConfig {
	...
	flags.CheckExclusive(ctx, MainnetFlag, SepoliaFlag, HoodiFlag, BeaconConfigFlag, ChiadoFlag, GnosisChainFlag)
	switch {
	case ctx.Bool(MainnetFlag.Name):
